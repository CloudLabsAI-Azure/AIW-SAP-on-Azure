...
10. Run all the commands one by one by clicking the **Run cell** icon present on the left side of each cell in the notebook.
 ...
 >**Note**: The notebook will take approximately 30 minutes to completely run, please wait for the previous command to be executed before proceeeding towards executing the next command. 

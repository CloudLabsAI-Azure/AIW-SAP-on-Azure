...
>**Note** Crossverify the API Key details when pasting it while setting up the encodian connection, as it might not work as expected if the key is wrong or there are additional spaces in between.
